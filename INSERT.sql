...
-- Inserted first two entries into employees table
-- Set the coffeeshop_id to NULL for now as I have not inserted the coffeeshop values into the shops table yet
...
-- Inserted the shop with coffeeshop_id = 1 into the shops table
-- Set to city_id to NULL for now as I have not inserted the city values into the locations table yet
INSERT INTO shops VALUES(1, 'Common Grounds', NULL);

-- Set the coffeeshop_id for the first two employees I inserted to 1
UPDATE employees
SET coffeeshop_id = 1 
WHERE employee_id IN (501559, 144108);

-- Inserted Los Angeles into the locations table
INSERT INTO locations VALUES(1, 'Los Angeles', 'United States');

-- Updated the city_id in the shops table for coffeeshop_id = 1 to 1
UPDATE shops
SET city_id = 1
WHERE coffeeshop_id = 1;

-- Inserted the first two values where coffeeshop_id = 1 into the suppliers table
INSERT INTO suppliers VALUES(1, 'Beans and Barley', 'Arabica');
INSERT INTO suppliers VALUES(1, 'Cool Beans', 'Robusta');

-- Inserted into the locations table
INSERT INTO locations VALUES(2, 'New York', 'United States');
INSERT INTO locations VALUES(3, 'London', 'United Kingdom');

-- Inserted into the shops table
...
-- Inserted into the suppliers table
...
-- Inserted all the remaining values into the employees table
